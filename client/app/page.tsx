...
export default function HomePage() {
  ...
  return (
    <div
      className="min-h-screen w-full bg-cover bg-center bg-fixed bg-linear-to-br from-blue-500/50 to-purple-600/50 transition-all duration-1000 "
    >
      {/* HERO SECTION */}
      <section className="py-28 text-white backdrop-blur-sm">
      ...
      {/* CTA SECTION */}
      <section className="py-24 text-white bg-gray-900/40 backdrop-blur-sm">
